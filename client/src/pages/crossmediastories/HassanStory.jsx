  ...
  const timelineData = [
    {
      id: 1,
      tag: "البداية والشغف",
      title: "طفولة مليئة بالحركة والمرح",
      description: "كان الطفل السوداني حسن، ذو الأعوام الستة، يعيش طفولة مليئة بالحركة والمرح. كان يحب المدرسة كثيراً، ويقضي أوقاته في اللعب والجري مثل أي طفل في عمره، كما عُرف بنشاطه وحبه للتعلم، خاصة مادة اللغة الإنجليزية التي كان يستمتع بدراستها دائماً.",
    ...
    },
    {
      id: 2,
      tag: "الفقد والصدمة",
      title: "طفولة سرقتها الحرب",
      description: "مع اندلاع الحرب في السودان، تبدلت حياة حسن بشكل مأساوي بعدما فقد شقيقه، ليجد نفسه وحيداً وسط أجواء الخوف والدمار. أصبحت أصوات الانفجارات جزءاً من يومه، إذ كان يستيقظ يومياً على دوي القصف، وهو ما تسبب له في نوبات متكررة من القلق والفزع.",
      icon: <FaGhost className="text-rose-400" />,
      image: "/assets/images/hassan.png"
    },
    {
      id: 3,
      tag: "المعركة الصامتة",
      title: "التعلق بالأم والتمسك بالتعلم",
      description: "تعلق حسن بوالدته بشكل أكبر، وأصبح يخشى الابتعاد عنها أو الخروج بمفرده بعدما فقد شعوره بالأمان وبات يخاف من الذهاب إلى المدرسة. ورغم تلك الظروف القاسية، لم يتخل عن شغفه بالتعلم، فصار يذاكر اللغة الإنجليزية في المنزل ويقضي معظم وقته في اللعب وحيداً.",
      icon: <FaHome className="text-purple-400" />,
      image: "/assets/images/hassan_mother.png"
    },
    {
      id: 4,
      tag: "رؤية الغد",
      title: "أمل بريء كطفولته.. ملاذ آمن لكل طفل",
      description: "رغم صغر سنه، يحمل حسن حلماً كبيراً للمستقبل؛ إذ يتمنى عندما يكبر أن ينشئ مكاناً مخصصاً للأطفال، يستطيعون فيه اللعب والعيش من دون خوف. يحلم بأن يكون ذلك المكان آمناً ودافئاً، يحتضنهم ويطمئنهم عندما يشعرون بالخوف، تماماً كما كان يتمنى لنفسه.",
      icon: <FaSmileWink className="text-emerald-400" />,
      image: "/assets/images/hassan_dream.png"
    }
  ];
    ...
    <div className="min-h-screen bg-[#0e1e2c] font-sans antialiased text-slate-200" dir="rtl">
      ...
      <header className="relative h-screen bg-gradient-to-b from-[#1a3147] via-[#0e1e2c] to-[#0e1e2c] flex flex-col items-center justify-center overflow-hidden px-4">
        <div style={{backgroundAttachment: "fixed",
          backgroundRepeat: "no-repeat"}} className="absolute inset-0 opacity-10 bg-[url('https://i.dailymail.co.uk/1s/2023/09/20/15/75642473-0-image-a-153_1695220203332.jpg')] bg-cover bg-center"></div>
        ...
        <div className="relative z-10 text-center max-w-4xl">
          ...
          <h1 className="text-4xl md:text-7xl font-black text-white mt-8 mb-6 tracking-tight leading-tight">
            عقله وبراءته.. <br className="hidden md:block" /> تفوق المحارب
          </h1>
          <p className="text-lg md:text-2xl text-slate-300 max-w-3xl mx-auto font-light leading-relaxed">
            حكاية الطفل السوداني حسن، البالغ من العمر 6 سنوات، الذي واجه الفقد وظلمات الحرب بشغف التعلم وحلم بريء يحمي أطفال الغد.
          </p>
        </div>
      ...
      <main className="pt-20 pb-10 overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto px-6 mt-32 border-t border-blue-950/40 pt-12 flex justify-between items-center gap-4">
          ...
          {/* زر الصفحة السابقة - لربطه استخدم tag <a> أو <Link> الخاص بـ react-router */}
          <a 
