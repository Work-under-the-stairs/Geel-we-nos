  ...
  const timelineData = [
    {
      id: 1,
      tag: "قبل الحرب",
      title: "أدهم وألمى.. أحلام طفولية بريئة",
      description: "في غزة العزة، كان الطفل أدهم (7 أعوام) يعيش حياة يملؤها الشغف والبهجة مع أخويه فادي وألمى. كان طفلاً متميزاً يحب القراءة، ويعشق الغناء، ويقضي أوقاته ممتلئاً بالنشاط وهو يلعب كرة القدم كأي طفل يحلم بمستقبل هادئ.",
      icon: <FaChild className="text-blue-400" />,
      image: "/assets/images/adhamwlama1.jpeg",
      hasAudio: true,
      audioLabel: "بصوته البريء يغني أدهم: أرضي صغيرة",
      audioSrc: "/assets/audio/adhamissining.ogg"
    },
    {
      id: 2,
      tag: "الفقد وألم الفراق",
      title: "قصف المنزل ورحيل ألمى المفجع",
      description: "انقلبت الحياة فجأة إثر غارة عنيفة استهدفت منزلهم. تعرضت العائلة بأكملها للإصابة، وفقد أدهم منزله وأخته الحبيبة 'ألمى' التي لم تتجاوز العاشرة من عمرها. يعبر أدهم بنبرة حزينة ومؤثرة عن حجم الصدمة قائلاً: 'نفسيتي اكتير اكتير تعبت، وزعلان اني طلعت من غزة'.",
      icon: <FaHeartBroken className="text-rose-400" />,
      image: "/assets/images/lama.jpeg",
      hasAudio: true,
      audioLabel: "أدهم يصف حالته النفسية بعد القصف",
      audioSrc: "/assets/audio/verysad.ogg"
    },
    {
      id: 3,
      tag: "قوة الرضا",
      title: "إيدي سبقتني على الجنة",
      description: "أسفر القصف عن بتر يد أدهم الصغيرة. ورغم فداحة الإصابة وعمق الوجع, أذهل أدهم العالم بعبارة صاغتها عائلته في قلبه بيقين راسخ: 'صح ايدي اتبترت بس الحمد الله على كل حال.. هي سبقتني على الجنة وأنا راضي بقضاء الله'. لم تقف عزيمته هنا، بل راح يتلو سورة التكوير غيباً بنبرة فخر واعتزاز.",
      icon: <FaHandHoldingHeart className="text-purple-400" />,
      image: "/assets/images/adham_prewar.jpeg",
      hasAudio: true,
      audioLabel: "تسجيل صوتي: أدهم يتحدث عن يده المبتورة",
      audioSrc: "/assets/audio/edysaba2tny.ogg"
    },
    {
      id: 4,
      tag: "النهوض والتفوق",
      title: "أجيال الحروب.. سابقة بخطوة",
      description: "انتقل أدهم إلى مصر ليستكمل رحلة العلاج والتعليم، ولم يستسلم للحظة واحدة. انتظم في فصوله الدراسية وتفوق ليتم تكريمه مكللاً بالافتخار وسط أوائل الصف الأول الابتدائي. أدهم لم ينس غزة يوماً، ويردد دائماً رغبته الصادقة في العودة إليها ليتعلم من أجل وطنه.",
      icon: <FaGraduationCap className="text-emerald-400" />,
      image: "/assets/images/adhamatschool.jpeg",
      hasAudio: true,
      audioLabel: "أدهم: أنا بتعلم بمصر وبدرس في...",
      audioSrc: "/assets/audio/anabat3alemfmaser.ogg"
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-[#0e1e2c] font-sans antialiased text-slate-200" dir="rtl">
      ...
      <header className="relative h-screen bg-gradient-to-b from-[#172a3a] via-[#0e1e2c] to-[#0e1e2c] flex flex-col items-center justify-center overflow-hidden px-4">
        <div style={{ backgroundAttachment: "fixed", backgroundRepeat: "no-repeat" }} className="absolute inset-0 opacity-10 bg-[url('https://cdn.observer.co.uk/media/original_images/18005.jpeg')] bg-cover bg-center"></div>
        ...
        <div className="relative z-10 text-center max-w-4xl">
          <span className="bg-rose-500/10 text-rose-300 px-5 py-2 rounded-full text-xs font-semibold border border-rose-500/20 uppercase tracking-wider">
            غزة العزة • جيل الصمود • إيمان راسخ
          </span>
          <h1 className="text-4xl md:text-7xl font-black text-white mt-8 mb-6 tracking-tight leading-tight">
            إيدي سبقتني على الجنة.. <br className="hidden md:block" /> البطل الصغير أدهم
          </h1>
          <p className="text-lg md:text-2xl text-slate-300 max-w-3xl mx-auto font-light leading-relaxed">
            قصة طفلٍ واجه آلة الدمار بروحٍ فاق عمرها الكبار؛ فقد يده وشقيقته، وحمل لوطنه حباً لا ينضب علّمه معنى الرضا والثبات.
          </p>
        </div>
                      ...
                      <div className="flex-1">
                        <div className="flex items-center justify-between mb-1.5 h-6 select-none">
                          <div className="text-xs font-semibold text-blue-300">
                            {isThisAudioPlaying ? "جاري الاستماع لتسجيل أدهم..." : item.audioLabel}
                          </div>
                          ...
                          <div className="flex items-center gap-[3px] h-6 px-1" dir="ltr">
                            {[
                              ...
                              <span
                                key={i}
                                className={`w-[3px] bg-gradient-to-t from-blue-500 to-cyan-400 rounded-full transition-all duration-300 ${isThisAudioPlaying ? 'animate-wave-bar' : bar.h
                                  }`}
