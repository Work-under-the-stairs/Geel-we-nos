  ...
  return (
    <div className="min-h-screen bg-white text-[#111827] font-arabic py-16 px-4 sm:px-6 lg:px-8" dir="rtl">
      ...
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="bg-slate-50 border-r-4 border-[#0d4857] p-6 rounded-l-2xl shadow-sm">
        ...
        <div className="bg-slate-50 border-r-4 border-[#fc6955] p-6 rounded-l-2xl shadow-sm">
          <p className="text-lg md:text-xl leading-relaxed text-gray-700 text-justify font-medium">
        ...
        <div className="bg-[#0d4857] text-white border-r-4 border-[#fc6955] p-6 rounded-l-2xl shadow-md">
