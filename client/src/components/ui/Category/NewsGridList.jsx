...
export default function NewsGridList({ extraArticles = [] }) {
  ...
  // خلفية الـ SVG الافتراضية لعرضها في حالة عدم وجود صورة نهائياً
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 animate-fadeIn" dir="rtl">
      {extraArticles.map((art) => {
        // ✅ استخراج آمن لرابط الصورة ليدعم الـ Object الجديد والـ String القديم
        ...
        return (
          ...
          >
            ...
            <div className="aspect-[16/10] w-full rounded-xl overflow-hidden bg-slate-800 mb-3">
              <img
                // ✅ استخدام الرابط المؤمّن هنا
                src={artImgUrl || defaultSvg}
                alt={art.title}
                className="w-full h-full object-cover group-hover:scale-103 transition-transform duration-500"
                onError={(e) => {
                  e.target.onerror = null; // تأمين إضافي لمنع اللوب اللانهائي
