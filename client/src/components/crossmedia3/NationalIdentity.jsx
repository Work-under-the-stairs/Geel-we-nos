...
const NationalIdentity = () => {
  ...
  const palaceDetails = {
    build: {
      ...
      text: "يمثل قصر الزعفران العريق، الذي يشغل اليوم مقر إدارة جامعة عين شمس بالقاهرة، شاهداً حياً على تاريخ مصر الحديث، ويعود تاريخ تشييده إلى عامي 1901-1902.",
      bgImage: "/assets/crossmedia3/Zafaran_palace.jpg"
    },
    name: {
      icon: "🌸",
      title: "عبير الزعفران",
      text: "أما سر تسميته، فيرجع إلى حدائق الزعفران الشاسعة التي كانت تحيط به، وتعطّر أجواء المنطقة برائحتها الذكية.",
      bgImage: "/assets/crossmedia3/palace-saffron.jpg"
    },
    treaty: {
      icon: "📜",
      title: "معاهدة 1936",
      text: "وقد احتضنت قاعات القصر التاريخي توقيع معاهدة 1936 الشهيرة بين مصر وبريطانيا.",
        ...
        <div className="w-full lg:w-1/2 flex flex-col gap-6">
          ...
          <div className="relative bg-[#14100c]/80 backdrop-blur-md border-r-4 border-[#d4b483] p-6 md:p-8 rounded-l-xl shadow-2xl mt-4">
            ...
            <p className="text-gray-300 text-sm md:text-base leading-relaxed text-justify font-light relative z-10 mt-5 pt-5 border-t border-white/5">
              ويضيف بدوي أن المتاحف بات بمقدورها الآن تقديم التاريخ بأسلوب مبسط وتفاعلي، يعتمد فيه الطفل على الصورة والتجربة بدلاً من النصوص الجامدة؛ وذلك عبر الاستعانة بالوسائط المتعددة، والعروض السمعية والبصرية، والتقنيات الرقمية التي تساعده على استيعاب تاريخه الوطني بطريقة ممتعة، وتجعله يشعر بأن الماضي جزء لا يتجزأ من هويته الحاضرة.
            </p>
          </div>
        </div>
