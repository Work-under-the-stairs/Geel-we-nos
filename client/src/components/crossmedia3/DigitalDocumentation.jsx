...
const DigitalDocumentation = () => {
  ...
  const docFeatures = {
    archive: {
      ...
      target: "لحفظ البيانات والمقتنيات",
      desc: "اعتمد المتحف على أساليب التوثيق الرقمي الحديثة لحفظ البيانات، والصور، والمعلومات الخاصة بالمقتنيات؛ بما يضمن الحفاظ عليها علمياً، وإتاحتها بكفاءة عالية للأغراض البحثية والتعليمية للأجيال القادمة."
    },
    hologram: {
      icon: '👁️',
      title: "تقنيات الهولوجرام",
      target: "إضفاء بعد درامي وتفاعلي حي",
      desc: "استخدام تقنيات 'الهولوجرام' والعروض البصرية الحديثة أضفى بعداً درامياً وتفاعلياً، وساعد على تقديم الشخصيات التاريخية والعناصر التراثية بصورة حية وجذابة، ما سهل التواصل مع الزوار، وضاعف من تأثير الرسالة المتحفية."
    },
    multimedia: {
      icon: '🏺',
      title: "الوسائط المتعددة",
      target: "تفاعل مباشر يجمع الصوت والصورة",
      desc: "اعتمد المتحف على شاشات ذكية ووسائط متعددة تجمع بين الصوت والصورة والفيديو، وهو ما أتاح للزائر التفاعل المباشر مع المحتوى، واستكشاف المعلومات بطريقة معاصرة تتناسب مع طبيعة الجمهور واهتماماته."
    }
  };
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 28 }}>
            ...
            <p style={{ fontFamily: "'Arial', sans-serif", fontSize: 16, lineHeight: 1.85, color: 'rgba(245,237,214,0.72)', borderRight: '3px solid #C9A84C', paddingRight: 20, margin: 0, textAlign: 'justify' }}>
              ...
              لتناسب طبيعة الأجيال الجديدة واهتماماتهم المعاصرة.
            </p>
          </div>
