...
const TechMinistrySection = () => {
  ...
  return (
    <div className="relative z-20 w-full font-sans bg-slate-950 overflow-hidden" dir="rtl">
      <CursorGlow />
      ...
      {/* Social Media / Soft Skills Section */}
      ...
      <section className="relative z-10 w-full pt-16 pb-32">
        <div className="max-w-6xl mx-auto px-4 md:px-6 relative z-30">
          ...
          <div>
            <FadeUpScroll>
              <h3 className="text-2xl md:text-3xl font-extrabold text-white mb-8 border-r-4 border-cyan-500 pr-4 drop-shadow-md">
                شروط الالتحاق
              </h3>
            </FadeUpScroll>
